...
CREATE TYPE saga_status_enum AS ENUM ('STARTED', 'FAILED', 'SUCCEEDED', 'PROCESSING', 'COMPENSATING', 'COMPENSATED');
...
(
    ...
    saga_status saga_status_enum NOT NULL,
    order_status order_status NOT NULL,
...
CREATE CAST (VARCHAR AS saga_status_enum) WITH INOUT AS IMPLICIT;
