...
public class OrderPaymentSaga implements SagaStep<PaymentResponse, OrderPaidEvent, EmptyEvent> {
    ...
    public OrderPaymentSaga(OrderDomainService orderDomainService, OrderSagaHelpler orderSagaHelpler, OrderPaidRestaurantRequestMessagePublisher orderPaidRestaurantRequestMessagePublisher) {
    ...
    public OrderPaidEvent process(PaymentResponse paymentResponse) {
        ...
        Order order = orderSagaHelpler.findOrder(paymentResponse.getOrderId());
